...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if temperature * neutrons_produced_per_second > (1 - MARGIN_OF_CRITICALITY) * threshold and temperature * neutrons_produced_per_second < (1 + MARGIN_OF_CRITICALITY) * threshold :
        return "NORMAL"
