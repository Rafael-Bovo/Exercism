...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    MARGIN_OF_CRITICALITY = 0.1
    
    if temperature * neutrons_produced_per_second < (1 - MARGIN_OF_CRITICALITY) * threshold:
        return "LOW"

    elif temperature * neutrons_produced_per_second > (1 - MARGIN_OF_CRITICALITY) * threshold and temperature * neutrons_produced_per_second < (1 + MARGIN_OF_CRITICALITY) * threshold :
        return "NORMAL"
