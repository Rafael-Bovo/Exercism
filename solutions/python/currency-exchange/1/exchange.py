...
def exchange_money(budget, exchange_rate):
    ...
    budget_exchange = budget / exchange_rate
    return budget_exchange
...
def get_leftover_of_bills(amount, denomination):
    ...
    number_of_bills = int(amount/denomination)
    leftover_of_bills = amount - (number_of_bills*denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    total_currency = budget / effective_rate
    max_value = (int(total_currency / denomination)) * denomination
    return max_value